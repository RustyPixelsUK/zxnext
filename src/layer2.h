...
void layer2_tilemap_draw_tile(uint8_t tile_id, uint8_t tile_attribs, void *dst, void *src);
void layer2_tilemap_draw_column(uint8_t pixel_x, uint8_t tile_attribs, void *dst, void *src);
void layer2_tilemap_draw_row(uint8_t pixel_y, uint8_t tile_attribs, void *dst, void *src);
...
void layer2_tile_get_offset(void);
void layer2_tilemap_update_column(void);
void layer2_tilemap_update_row(void);
void layer2_tilemap_update(void);
void layer2_tilemap_update_edges(void);
void layer2_tilemap_scroll_update(void);
void layer2_tilemap_scroll_left(void);
void layer2_tilemap_scroll_right(void);
void layer2_tilemap_scroll_up(void);
void layer2_tilemap_scroll_down(void);
